<template>
	<view class="uni-calendar-item__weeks-box" :style="getItemStyle(weeks)" :class="{
...
<script>
	...
	export default {
		...
		methods: {
			...
			getItemStyle(weeks) {
			  const color = this.customColorMap?.[weeks.fullDate]
			  return color ? `background-color: ${color}; border-radius: 12rpx;` : ''
			}
		}
	}
</script>
